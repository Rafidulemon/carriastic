...
import { FaBriefcase, FaUserTie, FaLaptopCode, FaBullhorn, FaPaintBrush, FaPenNib } from "react-icons/fa";
...
const Services = () => {
  ...
  const services = [
    ...
    {
      name: "Job Placement",
      details: "Get assistance to land your dream job with our placement services.",
      icon: <FaBriefcase />,
    ...
    },
    {
      ...
      details: "Receive personalized career advice from our experienced consultants.",
      icon: <FaUserTie />,
      color: "text-blue-800",
    ...
    },
    {
      ...
      details: "Build modern, scalable, and efficient software solutions with our expert team.",
      icon: <FaLaptopCode />,
      color: "text-red-800",
    ...
    },
    {
      ...
      details: "Boost your online presence and grow your business with our digital marketing services.",
      icon: <FaBullhorn />,
    ...
    },
    {
      ...
      details: "Create visually stunning graphics that captivate and engage your audience.",
      icon: <FaPaintBrush />,
      color: "text-pink-800",
    ...
    {
      name: "UI/UX Design",
      details: "Design seamless and user-friendly interfaces for your digital products.",
      icon: <FaPenNib />,
      color: "text-teal-800",
