...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  return (
    <div
      className={`group w-full md:w-[300px] xl:w-[350px] flex flex-col items-center justify-center p-6 rounded-md shadow-md ${background} 
    ...
    >
      ...
      <p
        className="text-gray-600 text-center mt-2 group-hover:text-white transition-colors duration-300"
      >
        {details}
      </p>
    </div>
